...
const mockData = [
  ...
  },
  {
    seq: 7,
    tag:
      "안녕하세요 학생 여러분 코로나 사태가 지속되면서 온라인 비대면 수업도 이어지고 있네요",
    content: "수정한 콘텐츠",
    start: "2020-04-30",
    end: "2020-05-10",
    teamPlan: null,
...
export default function App(props) {
  ...
  return (
    <div>
      <SelectDateDialog
        updatePlan={updatePlanList}
        updatePlanList={updatePlanList}
        messageBoxHandle={messageBoxHandle}
        open={selectDateDialog}
        handleClose={() => setSelectDateDialog(false)}
        selectDate={selectDate}
        eventList={fileterEventList}
      />
      <SchedulerSection
        updatePlanList={updatePlanList}
        location={props.match.params.idx}
